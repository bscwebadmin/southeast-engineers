...
| *`data-aos-easing`* | Choose timing function to ease elements in different ways | easection-in-sine | ease |
...
```html
  <div data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="easection-in-sine" data-aos-duration="600">
```
```html
...
You can choose one of these timing function to animate elements nicely:
  ...
  * easection-in-back
  * easection-out-back
  * easection-in-out-back
  * easection-in-sine
  * easection-out-sine
  * easection-in-out-sine
  * easection-in-quad
  * easection-out-quad
  * easection-in-out-quad
  * easection-in-cubic
  * easection-out-cubic
  * easection-in-out-cubic
  * easection-in-quart
  * easection-out-quart
  * easection-in-out-quart
