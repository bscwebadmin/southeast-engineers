...
- **[Improvement]** Make sorting casection-insensitive (thanks @thomasklemm)
...
- Fuzzy Search plugin, `.filter()` changes and bug fixes _[Read more »](http://jonnystromberg.com/listjs-0-2-1-releasection-notes/)_
